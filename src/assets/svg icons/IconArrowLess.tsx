// icon:left-open-mini | Entypo http://entypo.com/ | Daniel Bruce
import * as React from 'react';

function IconArrowLess(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 265 1000" {...props}>
